...
For t = 2 To Lastrow_Ticker:

If ws.Range("K" & t + 1).Value > Greatest_Increase Then
Greatest_Increase = ws.Range("K" & t + 1).Value
 Greatest_Increase_Ticker = ws.Range("I" & t + 1).Value

ElseIf ws.Range("K" & t + 1).Value < Greatest_Decrease Then
Greatest_Decrease = ws.Range("K" & t + 1).Value
Greatest_Decrease_Ticker = ws.Range("I" & t + 1).Value

ElseIf ws.Range("L" & t + 1).Value > Greatest_Total Then
 Greatest_Total = ws.Range("L" & t + 1).Value
Greatest_Total_Ticker = ws.Range("I" & t + 1).Value
